# Viboro Creator Lab — Credentials & Secrets
...
- `TOKEN_ENCRYPTION_KEY` — 64 hex chars (crypto.randomBytes(32))
- `CRON_SECRET` — 48 hex chars (crypto.randomBytes(24))

## Test users
None created yet. Phase 8 cross-user isolation tests still pending (see PRD.md).
