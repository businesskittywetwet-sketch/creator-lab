        ...
        <div className="fixed inset-0 z-[80] grid place-items-center p-4">
          ...
          <div className="panel relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-[#0a0c12] p-6 shadow-2xl animate-fade-up">
            <div className="mb-5 flex items-start justify-between">
              <div>
                <p className="eyebrow mb-1.5">Publishing strategy</p>
                <h3 className="font-display text-lg font-bold text-white">{strategy.channelName}</h3>
              </div>
              <button
                onClick={() => setOpen(false)}
            ...
            <form action={formAction} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="flex justify-end gap-2 pt-2 sm:col-span-2">
                ...
                <SubmitButton label="Save strategy" />
              </div>
            </form>
          </div>
        </div>
