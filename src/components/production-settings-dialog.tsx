    ...
    <>
      ...
      {open && (
        <ModalDialog
          ...
          description="Controls how the production pipeline drafts content for this niche."
          ...
          footer={
            <div className="flex justify-end gap-2">
              ...
              <SubmitButton form="production-settings-form" label="Save production settings" />
            </div>
          }
        >
            <form id="production-settings-form" action={formAction} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
